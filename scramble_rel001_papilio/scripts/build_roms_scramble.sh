...
# set PATHs
rom_path_src=../roms/stern_scramble
rom_path=../build
...
# REM concatenate consecutive ROM regions
cat $rom_path_src/2d $rom_path_src/2e $rom_path_src/2f $rom_path_src/2h $rom_path_src/2j $rom_path_src/2l $rom_path_src/2m $rom_path_src/2p > $rom_path/rom.bin
