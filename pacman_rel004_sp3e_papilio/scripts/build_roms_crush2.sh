...
rom_path_src=../roms/crush2
rom_path=../build
romgen_path=../romgen_source

#REM concatenate consecutive ROM regions
cat $rom_path_src/tpa $rom_path_src/tpc $rom_path_src/tpb $rom_path_src/tpd > $rom_path/gfx1.bin
cat $rom_path_src/tp1 $rom_path_src/tp5a $rom_path_src/tp2 $rom_path_src/tp6 $rom_path_src/tp3 $rom_path_src/tp7 $rom_path_src/tp4 $rom_path_src/tp8 > $rom_path/main.bin
